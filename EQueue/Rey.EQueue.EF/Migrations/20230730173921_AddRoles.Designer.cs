...
namespace Rey.EQueue.EF.Migrations
{
    ...
    [Migration("20230730173921_AddRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rey.EQueue.Core.Entities.Security.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rey.EQueue.Core.Entities.Security.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rey.EQueue.Core.Entities.Security.UserRole", b =>
                {
                    ...
                    b.HasOne("Rey.EQueue.Core.Entities.Security.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
